...
import {
  Box, Typography, Paper, Chip, Button, Grid2 as Grid,
} from "@mui/material";
...
function SessionCard({ session: s, muted = false, live = false }: { session: SessionWithCount; muted?: boolean; live?: boolean }) {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Bottone vedi squadre — fuori dal corpo per non interferire con il link */}
        {hasTeams && (
