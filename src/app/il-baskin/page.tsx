...
const ROLES_INFO = [
  ...
  {
    role: 3,
    label: "Ruolo 3 — Il Giocatore Limitato",
    tag: "Mobile",
  ...
  {
    role: 4,
    label: "Ruolo 4 — Il Giocatore Avanzato",
    tag: "Tradizionale",
    canestro: "Solo canestro tradizionale",
    punteggio: "2 pt (avanti) • 3 pt (dietro la linea)",
    marcatura: "Da Ruolo 3 o Ruolo 4",
    description:
      "Atleta con uso delle mani, cammino e corsa fluida con palleggio regolare. Tira esclusivamente nei canestri tradizionali. Il Ruolo 5 non può marcarlo (difesa illegale). Non può effettuare l'entrata in terzo tempo. Prima di tirare deve obbligatoriamente effettuare un arresto. Valgono le infrazioni di passi e doppio (ma non i passi di partenza). Non può essere marcato da ruoli 5.",
  },
  {
    role: 5,
    label: "Ruolo 5 — Il Giocatore Completo",
    tag: "Completo",
    canestro: "Solo canestro tradizionale",
    punteggio: "2 pt (avanti) • 3 pt (dietro la linea)",
